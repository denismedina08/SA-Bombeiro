...
CREATE TABLE `localizacao_do_trauma` (
  `id_ocorrencia` int NOT NULL,
  `cabeça` tinyint(1) NOT NULL,
  `perna_direita` tinyint(1) NOT NULL,
  `perna_esquerda` tinyint(1) NOT NULL,
  `braço_direito` tinyint(1) NOT NULL,
  `braço_esquerdo` tinyint(1) NOT NULL,
  `torço` tinyint(1) NOT NULL,
...
CREATE TABLE `materias_utilizados_deixados_hospital` (
  ...
  `tirante_cabeça` tinyint(1) NOT NULL,
...
CREATE TABLE `problemas_encontrados_suspeitos` (
  ...
  `respiratorio_inalaçao_fumaçao` int NOT NULL,
...
CREATE TABLE `procedimento_efetuado` (
  `id_ocorrencia` int NOT NULL,
  `aspiraçao` tinyint(1) NOT NULL,
  `avaliaçao_inicial` tinyint(1) NOT NULL,
  `avaliaçao_dirigida` tinyint(1) NOT NULL,
  `avaliaçao_continua` tinyint(1) NOT NULL,
  ...
  `imobilizaçoes` tinyint(1) NOT NULL,
...
CREATE TABLE `sinais_sintomas` (
  ...
  `descorticaçao` tinyint(1) NOT NULL,
  `deformidade` tinyint(1) NOT NULL,
  `descerebraçao` tinyint(1) NOT NULL,
